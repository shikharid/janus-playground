...
sudo docker run -d --name=pappu-janus -p 7088:7088 -p 7889:7889 -p 8088:8088 -p 8089:8089 -p 1443:1443 -p 8989:8989 -p 12000-13000:12000-13000/udp shikharid/janus-pg
